import KioscoFooter from "../../../img/KioscoFooter.jpg";
import { Link } from "react-router";
function Footer() {
  return (
    <footer className="py-4 back">
      <div className="container">
          ...
          <div className="col-12 col-lg-6 navbar-expand text-center">
            <ul className="list-unstyled d-block d-lg-flex justify-content-center mb-3 mb-lg-0">
              <li className="nav-item">
                <Link
                  to={"/"}
                  className="text-dark text-decoration-none me-lg-3"
                  href=""
                >
                  Home
                </Link>
        ...
        <div className="row pb-3">
          <div className="col-12 text-center small text-muted">
            © 2025 DespensaToto Derechos reservados.{" "}
